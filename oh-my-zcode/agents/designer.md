---
name: designer
description: UI/UX design, review, and implementation. Use for styling, responsive design, component architecture, and visual polish. 10x better UI/UX than the orchestrator.
color: magenta
model: inherit
tools:
  - Read
